      ...
      <div class="gutter_col flex justify-between pos-r">
        ...
        <div :class="{ 'slidein-left': data.show[1] }" class="slideout-right" style="width: 50%">
          ...
          <div class="mt-24 desc">
            Betweb3 uses blockchain technology to restore and optimize the interactive experience of traditional sports
            betting platforms for ease of use
          </div>
          <div class="flex justify-end" style="margin-top: 10vh">
            <img src="../../assets/1.png" v-if="state.active === 0" style="width: 70%" alt="" />
            <img src="../../assets/2.png" v-if="state.active === 1" style="width: 70%" alt="" />
            <img src="../../assets/3.png" v-if="state.active === 2" style="width: 70%" alt="" />
            <img src="../../assets/4.png" v-if="state.active === 3" style="width: 70%" alt="" />
            <img src="../../assets/5.png" v-if="state.active === 4" style="width: 70%" alt="" />
            <img src="../../assets/6.png" v-if="state.active === 5" style="width: 70%" alt="" />
