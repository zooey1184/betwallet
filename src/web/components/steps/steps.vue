<template>
  <div v-if="align === 'right'">
    ...
    <div class="line_right">
      ...
      <div
        class="bar_right"
        :style="{ top: state.step * state.active + 20 + 'px' }"
      ></div>
      <div
    ...
    <div class="flex justify-end">
      <Arrow
        ...
        :disabled="state.active === options.length - 1"
      />
    </div>
  </div>

  <div v-if="align === 'around'" class="flex items-center">
    <div style="width: 15vw" class="content-pane mr-24 flex flex-col">
      <div
        v-for="item in options[state.active].desc"
        class="desc_item text-align-right"
      >
        {{ item }}
      </div>
    </div>
    ...
    <div>
      ...
      <div class="line_left">
        <div class="pl-24 por-r">
          <div class="desc_hidden subTitle bg-blue" ref="clientRectRef">
            TEST
          </div>
          <div
            class="bar"
          ...
          <div
            v-for="(item, index) in options"
            @click="state.active = index"
            class="cursor-pointer item_around"
          >
